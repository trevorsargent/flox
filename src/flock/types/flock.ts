...
export class Flock {
  ...
  private params: ParamSet<number>
  private debugOptions: Context['debugOptions']

  constructor() {
    this.params = init().params
    this.debugOptions = init().debugOptions
  }
  ...
  tick() {
    this.updateFlockPopulation()
    this.updateFlockVelocities()
    this.updateFlockPositions()
  }
